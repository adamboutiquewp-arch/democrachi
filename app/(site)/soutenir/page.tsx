...
export const metadata: Metadata = {
  ...
  description:
    "DemoCrachi est un média indépendant qui vit grâce à ses lecteurs. Soutenez le combat avec un don libre.",
};
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-14">
            {[
              ...
              <div key={titre} className="flex flex-col items-center text-center p-6 border border-white/10">
                ...
                <p className="text-[12px] text-[#777] leading-relaxed">{texte}</p>
              </div>
            ))}
          </div>
